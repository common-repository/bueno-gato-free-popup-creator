...
//Common php functions for all the files
	...
	function bgt_pop_sq_my_new_text_sizes($initArray){
	...
	add_filter('tiny_mce_before_init', 'bgt_pop_sq_my_new_text_sizes');
    //function to init the edit box
    function bgt_pop_sq_common_editbox()
    {
        $settings = array(
    ...
    //function to parse the auto responder
    	function bgt_pop_parse_autoresponder_callback()
		{
