jQuery(document).ready(function(){
	...
	jQuery('#popup_edit_this_theme').click(function(){
		...
		//load the theme
		var data = {
				action: 'bgt_pop_popup_theme_loader',
	...
	//CHANGE THE BUTTON
		jQuery('#popup_edit_change_btn').click(function(){
			...
			var data = {
					action: 'bgt_pop_popup_show_buttons',
	...
	//GET POPUP CODE, save the code to db
		jQuery('#popup_getcodeb').click(function(){
			...
			var input_code = "";
			jQuery('#pop_bgt_container input[type="text"], #pop_bgt_container input[type="email"]').each(function(){
			...
			var data = {
					action: 'bgt_pop_popup_save_to_db',
...
/* -----------------------------------*/
	...
	jQuery('.listing_view_popup, .pop_manage_preview_pop').live('click', function(){
		...
		data = {
			action: 'bgt_pop_popup_manage_show_preview',
	...
	jQuery('#save_manage_popup_option').click(function(){
		...
		var data = {
				action: 'bgt_pop_popup_save_option',
	...
	jQuery('.pop_save_btn').click(function(){
		...
		var data = {
				action: 'bgt_pop_popup_save_listing_option',
				op_id: op_id, 
				appear_position: appear_position,
				appear_behavior: appear_behavior,
	...
	jQuery('.pop_delete_btn').click(function(){
		...
		//send the delete request
		var data = {
				action: 'bgt_pop_pop_delete_pop_option',
				op_id: op_id
		}
		jQuery.post(ajaxurl, data, function(){
		});
